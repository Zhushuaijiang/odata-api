...
namespace Yoisoft.DataBase.Repository
{
    ...
    public class DbFactory
    {
        ...
        {
            string providerName = ConfigurationManager.ConnectionStrings["OracleDbContext"].ProviderName;
            return GetIDatabaseByIoc(GetDbType(providerName).ToString(), "OracleDbContext");
        }
        /// <summary>
        /// 连接数据库
        /// </summary>
