...
namespace YoiEmr_Api.Controllers.Odata.Base
{
    ...
    /// </summary>
    public  class CODE_PROVANDCITYController : ODataController
    {
        #region  default
        /// <summary>
        /// 查询列表所有
        ...
        [HttpGet]
        [EnableQuery]
        public IHttpActionResult Get(ODataQueryOptions<CODE_PROVANDCITYEntity> odataQueryOptions)
        {
            Expression<Func<CODE_PROVANDCITYEntity, bool>> myfilter = null;
            if (odataQueryOptions.Filter != null)
            {
                myfilter = odataQueryOptions.Filter.ToExpression<CODE_PROVANDCITYEntity>();
            }
            try
            {
                CODE_PROVANDCITYService service = new CODE_PROVANDCITYService();
                var expression = LinqExtensions.True<CODE_PROVANDCITYEntity>();
                if (myfilter != null)
                {
        ...
        public void Put([FromODataUri] string key, CODE_PROVANDCITYEntity model)
        {
            CODE_PROVANDCITYService service = new CODE_PROVANDCITYService();
        ...
        /// </summary>
        /// <param name="model"></param>
        public void Post(CODE_PROVANDCITYEntity model)
        {
            CODE_PROVANDCITYService service = new CODE_PROVANDCITYService();
