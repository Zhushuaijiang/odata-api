...
namespace YoiEmr_Api.Controllers.Odata.Patient
{
    ...
    public class DiagnosisController : ODataController
    {
        ...
        [HttpGet]
        [EnableQuery]
        public IHttpActionResult Get(ODataQueryOptions<DiagnosisEntity> odataQueryOptions)
        {
            Expression<Func<DiagnosisEntity, bool>> myfilter = null;
            if (odataQueryOptions.Filter != null)
            {
                myfilter = odataQueryOptions.Filter.ToExpression<DiagnosisEntity>();
            }
            try
            {
                DiagnosisService service = new DiagnosisService();
                var expression = LinqExtensions.True<DiagnosisEntity>();
                if (myfilter != null)
                {
        ...
        public void Put([FromODataUri] string key, DiagnosisEntity model)
        {
            DiagnosisService service = new DiagnosisService();
        ...
        /// </summary>
        /// <param name="model"></param>
        public void Post(DiagnosisEntity model)
        {
            DiagnosisService service = new DiagnosisService();
