    ...
    public static class SqlHelper
    {
        ...
        public static DataTable IDataReaderToDataTable(IDataReader reader)
        {
            using (reader)
            {
                ...
                {
                    if (!objDataTable.Columns.Contains(reader.GetName(intCounter).ToUpper()))
                    {
                        objDataTable.Columns.Add(reader.GetName(intCounter).ToUpper(), reader.GetFieldType(intCounter));
                    }
                    else
                    {
                        objDataTable.Columns.Add(reader.GetName(intCounter).ToUpper()+ intCounter.ToString(), reader.GetFieldType(intCounter));
                    }
